...
android {
    namespace = "com.wangxingxing.videocollectionscompose"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.wangxingxing.videocollectionscompose"
        minSdk = 24
        targetSdk = 35
        versionCode = 100
        versionName = "1.0"
    ...
    applicationVariants.all {
        outputs.all {
            ...
            (this as com.android.build.gradle.internal.api.BaseVariantOutputImpl).outputFileName =
                "VideoCollectionsCompose-${buildType}-v${versionCode}-${versionName}.apk"
        }
    }
}
